<x-app-layout>
    ...
    <div class="py-6 pb-12 mb-12 px-3 lg:px-8">
        ...
        <div class="result-compare grid grid-cols-2 md:grid-cols-7 gap-2 mt-6">
            ...
            <div class="rounded-lg shadow-md bg-white">
                <h1 class="font-bold text-3xl text-center uppercase py-2 bg-orange-400 text-white m-2 rounded mb-4">BMRI</h1>
                <div class="list-value text-center">
                    <p class="p-2">1.00.</p>
                    <p class="p-2 bg-gray-200">1.00.</p>
                    <p class="p-2">1.00.</p>
            ...
            <div class="rounded-lg shadow-md bg-white">
                <h1 class="font-bold text-3xl text-center uppercase py-2 bg-orange-400 text-white m-2 rounded mb-4">BRIS</h1>
                <div class="list-value text-center">
                    <p class="p-2">1.00.</p>
                    <p class="p-2 bg-gray-200">1.00.</p>
                    <p class="p-2">1.00.</p>
