...
<aside class="z-40 main-sidebar invisible overflow-y-auto overflow-x-hidden">
	...
	<div class="list-menu flex flex-col justify-between" style="
...
">
		<div>
			...
			<a href="{{ url('member/compare') }}" class="@if(isset($compare)) active @endif">
				...
				<span>Komparasi Emiten</span>
			</a>
			<a href="{{ url('member/dictionary') }}" class="@if(isset($dictionary)) active @endif">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
				  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 4v12l-4-2-4 2V4M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
				</svg>
				<span>Kamus Fundamental</span>
			</a>
			<a href="{{ url('member/package') }}" class="@if(isset($package)) active @endif">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
		...
		<div>
			<footer class="text-center text-sm opacity-70">&copy; {{ date('Y') }}  PT Syariah Saham</footer>
		</div>
...
">
		...
		<a href="{{ url('member/dictionary') }}" class="p-2 @if(isset($dictionary)) bg-white text-green-400 @endif">
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
			  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 4v12l-4-2-4 2V4M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
			</svg>
		</a>
		<a href="{{ url('member/package') }}" class="p-2 @if(isset($package)) bg-white text-green-400 @endif">
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
			  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
			</svg>
		</a>
