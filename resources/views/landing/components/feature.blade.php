<div id="feature" class="feature section-2 text-center">
	...
	<div class="flex flex-col md:flex-row gap-4 my-8 w-full md:w-5/6 justify-center mx-auto">
		<div class="md:w-1/4 bg-white p-4 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="200">
			<img src="{{ asset('asset/landing/laporan_keuangan.svg') }}" alt="Fitur Realita Syariah Saham Indonesia" class="w-4/5 my-5 mx-auto">
		...
		<div class="md:w-1/4 bg-white p-4 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="400">
			<img src="{{ asset('asset/landing/screening_saham.svg') }}" alt="Fitur Realita Syariah Saham Indonesia" class="w-4/5 my-5 mx-auto">
		...
		<div class="md:w-1/4 bg-white p-4 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="600">
			<img src="{{ asset('asset/landing/comparasi.svg') }}" alt="Fitur Realita Syariah Saham Indonesia" class="w-4/5 my-5 mx-auto">
		...
		<div class="md:w-1/4 bg-white p-4 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="800">
			<img src="{{ asset('asset/landing/realita.svg') }}" alt="Fitur Realita Syariah Saham Indonesia" class="w-4/5 my-5 mx-auto">
